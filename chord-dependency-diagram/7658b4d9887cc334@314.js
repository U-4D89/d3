...
export default function define(runtime, observer) {
  ...
  main.variable(observer("data")).define("data", ["d3","FileAttachment","rename"], 
  async function(d3,FileAttachment,rename){
    return(
  ...
  main.variable(observer("rename")).define("rename", function(){
    return( name => name.substring(name.indexOf(".") + 1, name.lastIndexOf(".")))});


  main.variable(observer("names")).define("names", ["data","d3"], function(data,d3){
    return(
  ...
  main.variable(observer("chord")).define("chord", ["d3","innerRadius"], function(d3,innerRadius){
    return(
      d3.chordDirected()
  ...
  main.variable(observer("color")).define("color", ["d3","names"], function(d3,names){
  ...
  main.variable(observer("outerRadius")).define("outerRadius", ["innerRadius"], function(innerRadius){
    return(innerRadius + 10)
  });

  main.variable(observer("innerRadius")).define("innerRadius", ["width","height"], function(width,height){
    return(
